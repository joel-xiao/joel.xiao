...
defineProps<{ books: Record<string, any[]> }>()
...
<template>
  <div class="max-w-300 mx-auto">
    <p text-center mt--6 mb5 op50 text-lg italic>
      List of Books I’ve Read (with Reflections & Notes).
    </p>
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        <a
          href="https://github.com/joel-xiao/books"
          target="_blank"
    ...
    <div
      v-for="key, cidx in Object.keys(books)" :key="key" slide-enter
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <a href="https://github.com/joel-xiao/books" target="_blank" op50>All books on GitHub</a>
      </div>
      <hr>
      <SponsorButtons />
    </div>
  ...
  <div>
    <div class="table-of-contents">
      ...
      <ul>
        <li v-for="key of Object.keys(books)" :key="key">
